...
2. Click
   [![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/Kingson/ChatGPTWeb&env=OPENAI_API_KEY&env=CODE&project-name=ChatGPTWeb&repository-name=ChatGPTWeb), remember that `CODE` is your page password;
3. Enjoy :)
